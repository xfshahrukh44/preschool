...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create New Childcares</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{route('admin.childcare.index')}}">View Childcares</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-12">
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                          <form action="{{route('admin.childcare.store')}}" method="POST">
                              @csrf
                              <div class="form-body">
                                  <div class="row">
                                      <div class="col-md-4">
                                      ...
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              ...
                                              <input class="form-control" type="text" name="program_type">
                                          </div>
                                      </div>
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              {!! Form::label('licence_sub_type', 'Licence sub-type') !!}
                                              <input class="form-control" type="text" name="licence_sub_type">
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              ...
                                              <input class="form-control" type="text" name="physical_address">
                                          </div>
                                      </div>
                                      <div class="col-md-3">
                                          <div class="form-group">
