            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-12 p-0">
                    <div class="images-zag womenimg" data-aos="flip-left" data-aos-easing="linear" data-aos-duration="1500">
                        <figure>
                            <img src="images/teacher-standing-in-front-of-chalkboard-in-classroom-683x1024.jpg"
                                class="img-fluid" alt="">
                        </figure>
                    </div>
                </div>
                        ...
                        <form class="teacher-form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 pl-lg-1 pl-md-1">
                                    ...
                                    <input id="do_you_work_1" type="radio" class="do_you_work" name="do_you_work"
                                        value="1" required>
                                    <label for="do_you_work_1">
                                        <small><b>Yes</b></small>
                                    </label>
                                    <input id="do_you_work_0" type="radio" class="do_you_work" name="do_you_work"
                                        value="0" required>
                            ...
                            <div class="form-group form-group-work" hidden>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="age_worked_with"
                                            id="age_worked_with" placeholder="what age do you work with?">
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="loe" id="loe"
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 pl-lg-1 pl-md-1">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="about"
