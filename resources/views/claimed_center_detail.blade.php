    ...
    <section class="section-3">
        <div class="container-fluid">
            <div class="row" style="padding-left: 150px;padding-right: 150px;">
                 ...
                 <h2 style="color:#000; font-size:40px;" class=""> {{ $get_claimed_daycare_center_detail->name }} </h2>
                
                <div class="col-lg-12">
                    <div class="section-3-txt">
                        <figure><img src="{{ asset($get_claimed_daycare_center_detail->feature_image) }}" alt="" class="img-fluid"></figure>
                        <div class="section-3-img">
                            <figure><img src="{{ asset($get_claimed_daycare_center_detail->other_image_one) }}" style="height: 329px;width: 100%;" alt="" class="img-fluid"></figure>
                            <figure><img src="{{ asset($get_claimed_daycare_center_detail->other_image_two) }}" style="height: 329px;width: 100%;" alt="" class="img-fluid"></figure>
                        </div>
                        ...
                        <div class="section-3-main-txt">
                            ...
                            <div class="row" style="border: 1px solid #cec6c6; padding: 20px; margin-top: 50px; margin-bottom: 50px;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="post" action="{{ URL('review_store') }}">
                                        ...
                                        <input type="hidden" name="daycareid" value="{{ $get_claimed_daycare_center_detail->id }}" class="form-control" /> 
                    ...
                    <div class="section-3-form">
                        <form>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <input type="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Phone*">
                              </div>
                            <button type="submit" class="btn btn-primary">Submit</button>
                            <p class="para-2">
                                By clicking “Submit”, you agree to our <a href="">Terms of Use</a>
                                and <a href="">Privacy Policy.</a> You also consent to receive texts and calls, which may be autodialed, from us and our partner providers; however, your consent is not a condition to using our service.
                            </p>
                          </form>
                    </div>
                </div> -->
