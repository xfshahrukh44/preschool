<div class="form-body">
    ...
    <div class="form-group">
    	{!! Form::label('post_image', 'Post Image') !!}
    	    	{!! Form::text('post_image', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    </div>
</div><div class="col-md-12">
    <div class="form-group">
    	{!! Form::label('user_image', 'User Image') !!}
    	    	{!! Form::text('user_image', null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
    </div>
</div>
	</div>
</div>
