...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{url('/like/like')}}">View Like</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">Like Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::open(['url' => '/like/like', 'files' => true]) !!}
                        @include ('like.like.form')
                        {!! Form::close() !!}
                       </div>
                  </div>
              </div>
