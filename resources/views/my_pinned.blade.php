    ...
    <section class="back">
            ...
            <div class="profilebg1" style="<?php if (Auth::user()->banner_image != '') {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="profile1">
                            @if (Auth::user()->image != '')
                                <img src="{{ asset(Auth::user()->image ?? 'images/noimage.png') }}"
                                    style="height:175px; width:175px;" class="img-fluid">
                            @else
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <div
                    class="col-lg-5 col-md-0 col-sm-12 col-12 order-lg-2 order-md-3 order-sm-3 order-3 scroll main-height">
                            ...
                            <div class="newfeed">
                                ...
                                <div class="newfeed-profile-name">
                                    ...
                                    <img style="height:60px; width:60px; border-radius:50px"
                                        src="{{ asset(App\User::find($val_pinned->user_id)->image ?? 'assets/imgs/noimage.png') }}"
                                        class="img-fluid">

                                    <h4> {{ App\User::find($val_pinned->user_id)->name }} <span>
                                            {{ Carbon::parse($val_pinned->created_at)->diffForHumans() }} </span></h4>
                                ...
                                <div class="newfeed-image">
                                    ...
                                    <img style="height:400px; width:100%; border-radius:10px;"
                                        src="{{ asset(App\Models\Post::find($val_pinned->post_id)->image) }}"
                                        class="img-fluid">
                ...
                <div
                    class="col-lg-4 col-md-8 col-sm-12 col-12 order-lg-3 order-md-2 order-sm-2 order-2 sidebarleftprofile">
