...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{ url('/post/post') }}">Back</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">Post Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        ...
                        @include ('post.post.form', ['submitButtonText' => 'Update'])
