    ...
    <div class="sidebarleft">
        <div class="profilebuttons">
            <ul>
                ...
                <li><a class="<?php if($segment == "job-board"){ echo 'menu_active'; } ?>" href="{{route('job_board')}}"><img src="{{asset('images/notification1.png')}}"> Job Board </a></li>
                ...
                <li><a class="<?php if($segment == "my-pinned"){ echo 'menu_active'; } ?>" href="{{route('my_pinned')}}"><img src="{{asset('images/home1.png')}}"> My Pinned </a></li>
