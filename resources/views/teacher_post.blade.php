                                            ...
                                            <div class="profilein1">
                                                ...
                                                <div class="newfeed-commnet">
                                                    ...
                                                    <div class="commentbox">
                                                        <h4>
                                                            <input type="text" name="post" placeholder="Write Comment" style="height: 30px; !important; font-size: 15px;" required>
                                                        </h4>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="write-jus">
                                                ...
                                                <div class="post">
                                                    <button id="btn_post" type="submit"
                                                        class="btn  custom-btn">Post</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="newfeed">
                                                ...
                                                <div class="newfeed-profile-name">
                                                    ...
                                                    <h4> {{App\User::find($val_get_last->user_id)->name}} {{App\User::find($val_get_last->user_id)->lname}} <span>
                                                            {{ Carbon::parse($val_get_last->created_at)->diffForHumans() }}
                                                        </span></h4>

                                                    @if(Auth::user()->id == $val_get_last->user_id)
                                                    <button class="btn btn-danger" onClick="delete_post('{{$val_get_last->id}}');" style="position:absolute; right:50px;" >
                                                    ...
                                                    ?>
                                                        ...
                                                        <button class="btn btn-dark"  style="right:50px;"  onClick="delete_pined_post('{{$val_get_last->id}}')" ><span class="fa fa-thumbtack"> </span> </button>
                                                    
                                                    <?php }else{ ?>
                                                    
                                                        <button class="btn btn-secondary"  style="right:50px;"  onClick="add_pined_post('{{$val_get_last->id}}')" ><span class="fa fa-thumbtack"> </span> </button>
                                                ...
                                                <div class="newfeed-image">
                                                    ...
                                                    <img style="height:400px; width:100%; border-radius:10px;" src="{{asset($val_get_last->image)}}" class="img-fluid">
                                                ...
                                                <div class="new-feedbut">
                                                    ...
                                                    @if($get_like != '')
                                                    <button href="" onClick="unlike('{{$val_get_last->id}}','{{Auth::user()->id}}');" class="but0 but1"> <b> Liked </b> </button>
                                                    @else
                                                    <button href="" onClick="like('{{$val_get_last->id}}','{{Auth::user()->id}}');" class="but0 but2"> Like  </button>
                                                    @endif
                                                
                                                
                                                    <button href="" style="pointer-events:none;" class="but0 but2"> Comment ({{$get_comment_count}})</button>
                                                ...
                                                <div class="row post_comment">
                                                    ...
                                                    <div class="commentbox col-md-10">
                                                        ...
                                                        <h4> {{ App\User::find($val_comments->user_id)->name }} <span>
                ...
                <div class="col-lg-3 desktop-chat">
                    <div class="sidebarLeft side-ri">
                        <div class="searimg">
                            ...
                            @if(Auth::user()->image != '')
                            <img src="{{asset(Auth::user()->image)}}" class="img-fluid" style="height:70px;width:70px; border-radius:50px;">
                            @else
                            <img style="height:60px; width:60px; border-radius:50px;" src="{{asset('images/profilemain1.png')}}" class="img-fluid">
                            @endif
                        ...
                        <div class="user recent_users">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <img style="height:50px; width:50px; border-radius:50px;" src="{{asset($val_recent_post->user_image)}}" class="img-fluid">
                                    @else
                                    <img style="height:50px; width:50px; border-radius:50px;" src="{{asset('images/profilemain1.png')}}" class="img-fluid">
                                    @endif
