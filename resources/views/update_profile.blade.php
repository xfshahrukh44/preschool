...
<style>
    .profileparent .select2-container--default .select2-search--inline .select2-search__field {
        display: none;
    }
...
<body>
    ...
    <section class="back update-profile-sec">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-2 order-md-3 order-sm-3 order-3">
                    ...
                    <div class="profileparent update-form">
                            ...
                            <form action="{{ route('update_profile2') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="race" class="form-control" placeholder="Enter Race"
                                        value="{{ Auth::user()->race }}">

                                    <br><br>

                                    <label for="">Ethnicity :</label>
                                    <input type="text" name="ethnicity" class="form-control"
                                        placeholder="Enter Ethnicity" value="{{ Auth::user()->ethnicity }}">
                                    ...
                                    @if (!empty(Auth::user()->video))
                                        <a href="{{ asset(Auth::user()->video) }}" target="_blank"
