...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Providers #{{ $users3->id }}</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{ url('/users3/users3') }}">Back</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">Users3 Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::model($users3, [
                            'method' => 'PATCH',
                            'url' => ['/users3/users3', $users3->id],
                            'files' => true
                        ]) !!}

                        @include ('users3.users3.form', ['submitButtonText' => 'Update'])
