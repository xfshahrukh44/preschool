...
<div class="col-md-12">
    <div class="form-group">
    	...
    	{!! Form::textarea('address', null, ('required' == 'required') ? ['class' => 'form-control', 'id' => 'summary-ckeditor', 'required' => 'required'] : ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="col-md-12">
    <div class="form-group">
    	{!! Form::label('about', 'About Business') !!}
...
<div class="col-md-12">
    <div class="form-group">
    	...
    	{!! Form::textarea('about_preschool', null, ('required' == 'required') ? ['class' => 'form-control', 'id' => 'summary-ckeditor', 'required' => 'required'] : ['class' => 'form-control']) !!}
    </div>
</div>
