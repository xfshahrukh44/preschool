        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="top-bottom aos-init aos-animate" data-aos="flip-right" data-aos-easing="linear"
                    ...
                    <a href="{{route('become-a-provider')}}" style="text-align:center; margin-left:15px;"
                        class="custom-btn pink"> Enrolled Now </a>
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <div class="top-bottom two aos-init aos-animate" data-aos="flip-left" data-aos-easing="linear"
                    ...
                    <br><br><br><br><br>
                    <a href="{{route('become-a-teacher')}}" style="text-align:center; margin-left:15px;"
                        class="custom-btn pink"> Enrolled Now </a>
